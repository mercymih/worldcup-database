...
--
-- Name: games fk_team_game_opponenet; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_team_game_opponenet FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);


--
-- Name: games fk_team_game_winner; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_team_game_winner FOREIGN KEY (winner_id) REFERENCES public.teams(team_id);
